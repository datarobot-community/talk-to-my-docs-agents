...
import { getCurrentUser, logout as logoutRequest, updateUserMetadata } from './requests';
...
export const useUpdateUserMetadata = () => {
    ...
    >({
        mutationFn: data => updateUserMetadata(data),
        onMutate: async data => {
            ...
            queryClient.setQueryData<IUser>(authKeys.currentUser, old => {
                ...
                return {
                    ...
                    ...(data.theme !== undefined && { theme: data.theme as IUser['theme'] }),
                };
            });
            return { previousUser };
        },
