  ...
  `,
    {
        ...
        compoundVariants: [
            // Default type - destructive (error)
            {
                ...
                className:
                    'border-transparent bg-(--destructive) text-(--primary-foreground) shadow-sm',
            },
            // Default type - info
            {
                type: BADGE_TYPE.default,
        ...
        `,
          ...
          dark:border-[color-mix(in_srgb,var(--destructive)_70%,white)] dark:text-[color-mix(in_srgb,var(--destructive)_70%,white)]
        `,
            },
            // Outline type - info
            {
