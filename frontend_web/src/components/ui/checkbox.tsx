    ...
    return (
        <CheckboxPrimitive.Root
            ...
            className={cn(
                ...
                'hover:not-disabled:data-[state=checked]:bg-[color-mix(in_srgb,var(--accent)_80%,white)]',
                // Indeterminate state
                'data-[state=indeterminate]:bg-accent',
                'data-[state=indeterminate]:border-accent',
                'data-[state=indeterminate]:text-primary-foreground',
                'hover:not-disabled:data-[state=indeterminate]:bg-[color-mix(in_srgb,var(--accent)_80%,white)]',
